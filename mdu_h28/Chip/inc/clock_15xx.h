 ...
 */
STATIC INLINE void Chip_Clock_SetMain_A_ClockSource(
		CHIP_SYSCTL_MAIN_A_CLKSRC_T src) {
 ...
 */
STATIC INLINE CHIP_SYSCTL_MAIN_A_CLKSRC_T Chip_Clock_GetMain_A_ClockSource(
		void) {
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_Clock_SetMain_B_ClockSource(
		CHIP_SYSCTL_MAIN_B_CLKSRC_T src) {
 ...
 */
STATIC INLINE CHIP_SYSCTL_MAIN_B_CLKSRC_T Chip_Clock_GetMain_B_ClockSource(
		void) {
...
typedef enum CHIP_SYSCTL_USBCLKSRC {
	...
	SYSCTL_USBCLKSRC_SYSOSC = SYSCTL_USBCLKSRC_MAINOSC, SYSCTL_USBCLKSRC_PLLOUT, /*!< USB PLL out */
 ...
 */
STATIC INLINE void Chip_Clock_SetUSBClockSource(CHIP_SYSCTL_USBCLKSRC_T src,
		uint32_t div) {
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_Clock_SetADCASYNCSource(
		CHIP_SYSCTL_ADCASYNCCLKSRC_T src) {
...
typedef enum CHIP_SYSCTL_CLKOUTSRC {
	...
	SYSCTL_CLKOUTSRC_SYSOSC = SYSCTL_CLKOUTSRC_MAINOSC, SYSCTL_CLKOUTSRC_WDTOSC, /*!< Watchdog oscillator for CLKOUT */
