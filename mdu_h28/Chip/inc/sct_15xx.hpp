...
typedef struct {
	...
	union{
		...
		struct{
			__IO unsigned unify:1;
			__IO unsigned clkmode:2;
			__IO unsigned cksel:3;
			__IO unsigned noreload_h:1;
			__IO unsigned noreload_l:1;
			__IO unsigned insync:8;
			__IO unsigned autolimit_h:1;
			__IO unsigned autolimit_l:1;
		}CONFIG_bits;
	};
	union {
